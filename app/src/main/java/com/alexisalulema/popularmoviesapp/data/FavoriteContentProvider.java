...
import static com.alexisalulema.popularmoviesapp.data.FavoriteContract.FavoriteEntry.TABLE_NAME;
    ...
    public int delete(@NonNull Uri uri, @Nullable String s, @Nullable String[] strings) {
        ...
        switch (match) {
            ...
            case FAVORITES_WITH_ID:
                ...
                favoritesDeleted = db.delete(TABLE_NAME, FavoriteContract.FavoriteEntry.COLUMN_MOVIE_ID + "=?", new String[]{id});
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
